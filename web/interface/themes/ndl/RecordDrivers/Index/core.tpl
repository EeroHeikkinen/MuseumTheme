...
{* Display Cover Image *}
  ...
  {if $coreThumbMedium}
    <div class="alignright">
      ...
      {if $img_count > 1}
        <div id="imagelinks" style="text-align: right">
...
<table cellpadding="2" cellspacing="0" border="0" class="citation" summary="{translate text='Bibliographic Details'}">
  ...
  <tr valign="top">
    ...
    <td><a href="{$url}/Search/Results?lookfor=hierarchy_parent_id:{$id|escape:"url"}">{translate text='component_part_count_prefix'}{$coreComponentPartCount} {translate text='component_part_count_suffix'}</a></td>
  </tr>
  {/if}
