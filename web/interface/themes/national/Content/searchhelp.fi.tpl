...
{capture append="sections"}{literal}
  <h2 name="Wildcard Searches">Jokerimerkit</h2>
...
{/literal}{/capture}{capture append="sections"}{literal}
  <h2 name="Fuzzy Searches">Sumeat haut</h2>
...
{/literal}{/capture}{capture append="sections"}{literal}
  <h2 name="Proximity Searches">Etäisyyshaut</h2>
...
{/literal}{/capture}{capture append="sections"}{literal}
  <h2 name="Range Searches">Arvovälihaut</h2>
...
{/literal}{/capture}{capture append="sections"}{literal}
  <h2 name="Boosting a Term">Termin painottaminen</h2>
...
{/literal}{/capture}{capture append="sections"}{literal}
  <h2 name="Boolean operators">Boolean-hakuoperaattorit</h2>
  ...
  <h3 name="Phrase searches">Fraasihaut</h3>
...
{/literal}{/capture}{capture append="sections"}{literal}
  ...
  <h3 name="Search Fields">Hakukentät</h3>
  ...
  <h3 name="Search Groups">Hakuryhmät</h3>
