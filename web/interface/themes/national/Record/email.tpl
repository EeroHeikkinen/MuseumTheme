...
<form action="{$url}{$formTargetPath|escape}" method="post"  name="emailRecord">
    ...
    <input id="email_from" type="text" name="from" size="40" class="{jquery_validation required='This field is required' email='Email address is invalid'}"{if $user->email} value="{$user->email}"{/if}/>
