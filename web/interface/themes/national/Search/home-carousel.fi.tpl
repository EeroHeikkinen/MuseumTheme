...
<div class="slides_container">
      ...
      <li>
        ...
        <div class="pickup-content">
          ...
          <div class="pickup-text">
            ...
            <a href="{"https://astia.narc.fi/astiaUi/search.php?recordsCreator=maa+ja+mets%E4talousministeri%F6&location=&query=tyyppitalopiirustukset&hakutyyppi=normal&startDate=1316&endDate=2013"|escape:'url'}">» Hakutulokseen</a>
          </div>
        </div>
      </li>
      <li>
  ...
  <div class="slide">
    <ul> 
      ...
      <li>
        {image src="itsenaisyys.jpg"}
        <div class="pickup-content">
          <div class="pickup-header"><span>Suomen itsenäisyysjulistus</span></div>
          <div class="pickup-text">
            Itsenäisyysjulistus liittyy senaatin 4.12.1917 pitämään istuntoon, jossa
            senaatin talousosaston puheenjohtaja P. E. Svinhufvud ilmoitti eduskunnalle
            käsiteltäviksi annettavat esitykset. Ensimmäinen niistä koski Ståhlbergin
            perustuslakikomitean valmistelemaa Suomen uutta hallitusmuotoa, "joka on
            rakennettu sille perusteelle, että Suomi on oleva riippumaton tasavalta".
            Eduskunta hyväksyi esityksen istunnossaan 6.12.1917.
            <a href="{"https://astia.narc.fi/astiaUi/digiview.php?imageId=1030970&aytun=4424.KA&j=1"|escape:'url'}">» Hakutulokseen</a>
          </div>
        </div>
      </li>
      <li>
        {image src="sotapaivakirja.jpg"}
        <div class="pickup-content">
          <div class="pickup-header"><span>Sotapäiväkirjat</span></div>
          <div class="pickup-text">
            Sotapäiväkirjat ovat talvi- ja jatkosodan aikaisia päiväkirjamuotoon laadittuja
            esityksiä tietyn yksikön toiminnasta tiettynä aikana. Niiden avulla on
            mahdollista saada perustiedot siitä, missä alueella ja milloin joukko liikkui
            ja mihin sotatoimiin se osallistui. Myös rintaman takana suoritettu palvelus on
            yleensä kuvattu päiväkirjassa.
            <a href="{"http://wiki.narc.fi/portti/index.php/Sotap%C3%A4iv%C3%A4kirjat"|escape:'url'}">» Hakutulokseen</a>
          </div>
        </div>
      </li> 
      <li>
