      ...
      <li>
        ...
        <div class="pickup-content">
          ...
          <div class="pickup-text">
            ...
            <a href="{"http://www.finna.fi/Search/Results?lookfor=theorica+pantegni&type=AllFields&filter[]=building%3A%220%2FNLF%22&filter[]=authorStr%3A%22Constantinus+Africanus%22&view=list&lng=sv"|escape:'html'}">» Till sökresultatet</a>
          </div>
        </div>
      </li>
      <li>
        ...
        <div class="pickup-content">
          ...
          <div class="pickup-text">
            ...
            <a href="http://www.finna.fi/Record/lusto.M011-332446">» Till sökresultatet</a>
          </div>
        </div>
      </li>
      <li>
        ...
        <div class="pickup-content">
          ...
          <div class="pickup-text">
            ...
            <a href="http://www.finna.fi/Collection/narc.VAKKA-319655.KA">» Till sökresultatet</a>
          </div>
        </div>
      </li>
      <li>
        ...
        <div class="pickup-content">
          ...
          <div class="pickup-text">
            ...
            <a href="http://www.finna.fi/Record/metalib_finelib.FIN25672">» Till sökresultatet</a>
          </div>
        </div>
      </li>   
    </ul>
      ...
      <li>
        ...
        <div class="pickup-content">
          ...
          <div class="pickup-text">
            ...
            <a href="{"http://www.finna.fi/Search/Results?lookfor=v%C3%A4lsk%C3%A4rin+kertomuksia+digitoitu+julkaisu&type=AllFields&filter[]=building%3A%220%2FNLF%22&view=list"|escape:'html'}">» Till sökresultatet</a>
          </div>
        </div>
      </li>
      <li>
        ...
        <div class="pickup-content">
          ...
          <div class="pickup-text">
            ...
            <a href="http://www.finna.fi/Record/lusto.M011-124885">» Till sökresultatet</a>
          </div>
        </div>
      </li>
    </ul>
